 ...
 * method.
 *
 * The Bill class will also implement from the interfaces of Compare, Cloneable,
...
public class Bill implements Comparable<Object>, Cloneable, Serializable {
    ...
    /**the clone method will make a clone of a Bill object
     *
     * @throws CloneNotSupportedException
     * @return the result of the cloned Bill object
     */
    ...
    public int compareTo(Object o) {
        if(o instanceof Bill) {
            Bill other = (Bill) o;
            return this.getBill().compareTo(other.getBill());
        }
        else{
            return -2;
        }
