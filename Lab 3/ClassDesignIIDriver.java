...
//What is the primary difference between passing a primitive to a
//method versus passing an object?
//Passing an object can access the public methods and the primitive is only local
...
//A copy of the value from the primitive is made, which runs through the method
//This is stack.

//What about when an object is passed to a method?
//The object's instances will be local to the method.

//How then would you describe the scope of an object that has been passed
//to a method?
//The method can access the values of the object and its primitives.